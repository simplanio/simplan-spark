...
/** @author Abraham, Thomas - tabraham1
  ...
  */
class BatchSourceUtil(sparkAppContext: SparkAppContext, operatorContext: OperatorContext, operatorConfig: SparkBatchSourceConfig, defaultOptions: Map[String, String] = Map.empty) extends Logging {
