...
/** @author Abraham, Thomas - tabraham1
  ...
  */
class ConsoleStreamingSink(sparkAppContext: SparkAppContext, operatorContext: OperatorContext) extends AbstractStreamingSink(sparkAppContext, operatorContext) {
  override def customizeConfig(readerConfig: SparkStreamingSinkConfig): SparkStreamingSinkConfig = readerConfig.copy(format = "console")
}
