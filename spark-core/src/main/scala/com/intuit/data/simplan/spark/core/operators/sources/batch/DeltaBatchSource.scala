...
/** @author Abraham, Thomas - tabraham1
  ...
  */
class DeltaBatchSource(sparkAppContext: SparkAppContext, operatorContext: OperatorContext) extends AbstractBatchSource(sparkAppContext, operatorContext) {
  override def customizeReaderConfig(sourceConfig: SparkBatchSourceConfig): SparkBatchSourceConfig = sourceConfig.copy(format = "delta")
}
