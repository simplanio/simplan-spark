...
/** @author Abraham, Thomas - tabraham1
  ...
  */
class SocketStreamingSource(sparkAppContext: SparkAppContext, operatorContext: OperatorContext) extends AbstractStreamingSource(sparkAppContext, operatorContext, "socket")
