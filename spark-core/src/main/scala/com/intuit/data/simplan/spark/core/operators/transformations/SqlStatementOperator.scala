...
/** @author - Abraham, Thomas - tabaraham1
  ...
  */
class SqlStatementOperator(appContext: SparkAppContext, operatorContext: OperatorContext) extends SparkOperator[SqlStatementConfig](appContext, operatorContext) with Logging {
