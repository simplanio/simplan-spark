...
/** @author Abraham, Thomas - tabraham1
  ...
  */
class KafkaStreamingSource(sparkAppContext: SparkAppContext, operatorContext: OperatorContext) extends AbstractStreamingSource(sparkAppContext, operatorContext, "kafka")
