...
/** @author Abraham, Thomas - tabraham1
  ...
  */
class JsonStreamingSink(sparkAppContext: SparkAppContext, operatorContext: OperatorContext) extends AbstractStreamingSink(sparkAppContext, operatorContext) {
  override def customizeConfig(readerConfig: SparkStreamingSinkConfig): SparkStreamingSinkConfig = readerConfig.copy(format = "json")
