...
/** @author Abraham, Thomas - tabraham1
  *         Created on 17-Sep-2021 at 10:35 AM
  */
class CsvBatchSource(sparkAppContext: SparkAppContext, operatorContext: OperatorContext) extends AbstractBatchSource(sparkAppContext, operatorContext) {
  override def customizeReaderConfig(sourceConfig: SparkBatchSourceConfig): SparkBatchSourceConfig = sourceConfig.copy(format = "csv")
}
